...
<form name="frmArticle" method="post" action="${contextPath}" enctype="multipart/form-data">
	...
	<tr>
		<td width="150" align="center" bgcolor="#F93">글번호</td>
		<td>
	...
	<tr>
		<td width="150" align="center" bgcolor="#F93">작성자 아이디</td>
		<td>
	...
	<tr>
		<td width="150" align="center" bgcolor="#F93">제목</td>
		<td>
	...
	<tr>
		<td width="150" align="center" bgcolor="#F93">내용</td>
		<td>
	...
	<c:if test="${not empty article.imageFileName && article.imageFileName != 'null'}">
		<tr>
			<td width="20%" align="center" bgcolor="#F93" rowspan="2">이미지</td>
			<td>
	...
	<tr>
		<td width="20%" align="center" bgcolor="#F93">등록일자</td>
		<td>
