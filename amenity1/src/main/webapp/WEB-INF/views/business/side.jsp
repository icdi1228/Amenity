...
<body>
	<div class="list-group">
		...
		<a href="${contextPath}/business/b_myRes.do" class="list-group-item list-group-item-action list-group-item-light">예약확인</a>
		<a href="#" class="list-group-item list-group-item-action list-group-item-dark">마이페이지</a>
