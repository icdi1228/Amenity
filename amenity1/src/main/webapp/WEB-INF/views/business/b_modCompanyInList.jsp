          ...
          <div class="col-md-6 offset-md-3">
            <form name="modCompany" method="post" action="${contextPath}/business/updateCompanyInList.do" enctype="multipart/form-data">
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control" id="company" name="company" value="${modCompanyInfo.company}">
              </div>
              <div class="form-group row">
                <div class="col-md-6">
                  <label for="category">업체 종류</label>
                  <input type="text" class="form-control" id="category" name="category" value="${modCompanyInfo.category}">
                </div>
                <div class="col-md-6">
              ...
              <div class="form-group row">
                <div class="col-md-6">
                  ...
                  <input type="text" class="form-control" id="sample5_address" name="location" placeholder="주소" value="${modCompanyInfo.location}">
                  <label for="locationdetail">상세주소</label>
                  <input type="text" class="form-control" name="locationdetail" placeholder="상세주소" value="${modCompanyInfo.locationdetail}">
              ...
              <div class="form-group">
                ...
                <textarea class="form-control" id="detail" name="detail" maxlength="1000">${modCompanyInfo.detail}</textarea>
              </div>
