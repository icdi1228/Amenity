...
<script type="text/javascript"> 
 ...
 <title>business_findpwd</title>
</head>
<body>
  <h1 style="text-align:center">사업자 비밀번호 찾기</h1>
  <form class="form" name="business_findpwd" method="post" action="${contextPath}/business/businessFindPwd.do" enctype="multipart/form-data" onsubmit="return combineEmail() && combineBno();">
