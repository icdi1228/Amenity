...
<body>
  <h1 style="text-align:center">사업자 비밀번호 찾기</h1>
  <form class="form" name="business_findpw" method="post" action="${contextPath}/main/businessFindPw.do" enctype="multipart/form-data" onsubmit="return combineEmail() && checkPassword() && combineBno();">
  ...
  <h1 style="text-align:center">새 비밀번호 등록</h1>
  <form class="form" name="business_newpw" method="post" action="${contextPath}/main/businessNewPw.do" enctype="multipart/form-data" onsubmit="return combineEmail() && checkPassword() && combineBno();">
    <table border="0" align="center">
