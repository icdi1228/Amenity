...
<body>
  <h1 style="text-align:center">사용자 아이디 찾기</h1>
  <form class="form" name="business_findpwd" method="post" action="${contextPath}/user/userFindId.do" enctype="multipart/form-data" onsubmit="return combineEmail() && combineBno();">
